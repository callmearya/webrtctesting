...
// Automatically fill room code from URL if available
...
// Start webcam and show main content
webcamButton.onclick = async () => {
  ...
  // Show main page and enable buttons
...
callButton.onclick = async () => {
  ...
  await callRef.set({ offer, participantCount: 1 });
...
answerButton.onclick = async () => {
  ...
  await callRef.update({ participantCount: 2 });
